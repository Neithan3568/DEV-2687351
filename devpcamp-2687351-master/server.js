...
//Dpendencias de rutas
const bootcampRoutes = require('./routes/bootcampRoutes')

//Dependencia a conexion de base de datos
const conectDB = require('./config/db')



//Crear archivo .env del proyecto
dotenv.config({
    path: './config/.env'
})
...
const PUERTO = process.env.EXPRESS_PUERTO

app.listen(8888, 
        console.log(`Servidor ejecutando en puerto: ${8888}` .bgBlue.red))
